...
public class Enemy : MonoBehaviour
{
    ...
    public void SetWave(WaveConfig wc)
    {
        waveConfig = wc;
    }
    ...
    private void Fire()
    {
        GameObject proyectile = Instantiate(ProyectilePrefab, transform.position, ProyectilePrefab.transform.rotation) as GameObject;
        proyectile.GetComponent<Rigidbody2D>().velocity = new Vector2(0, -ProyectileSpeed);
        shotCounter = UnityEngine.Random.Range(minTimeBetweenShots, maxTimeBetweenShots);
